  ...
  <div class="header-section">
    ...
    <div class="logo">
        <a href="index.html">
            <span class="logo-img">
                <img src="{{asset('images/logo_sm.png')}}" alt="" height="26">
            </span>
                    ...
                    <ul class="dropdown-menu mailbox dropdown-menu-right">
                        ...
                        <li class="notification-scroll">
                            <div class="message-center">
                                <a href="#">
                                    <div class="user-img">
                                         <img src="{{asset('images/users/avatar-2.jpg')}}" alt="user" class="rounded-circle">
                                ...
                                <a href="#">
                                    <div class="user-img">
                                        <img src="{{asset('images/users/avatar-3.jpg')}}" alt="user" class="rounded-circle">
                                ...
                                <a href="#">
                                    <div class="user-img">
                                        <img src="{{asset('images/users/avatar-4.jpg')}}" alt="user" class="rounded-circle">
                                ...
                                <a href="#">
                                    <div class="user-img">
                                        <img src="{{asset('images/users/avatar-5.jpg')}}" alt="user" class="rounded-circle">
