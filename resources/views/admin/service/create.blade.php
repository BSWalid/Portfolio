...
<div class="card-body">
    ...
    <div class="general-label">
        <form class="form-horizontal" role="form" enctype="multipart/form-data" method="Post" action="{{route('service.store')}}">
             @csrf
            ...
            <div class="form-group row">
                ...
                <div class="col-md-10">
                    <button type="submit" class="btn btn-primary">Create Servie</button>
