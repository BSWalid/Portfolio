<x-app-layout>
    @section('content')
        ...
        <div class="page-head">
            <h4 class="mt-2 mb-2">Technologies</h4>
        </div>
                ...
                <div class="col-lg-12 col-sm-12">
                    ...
                    <div class="card m-b-30">
                        <div class="card-body table-responsive">
                            <h5 class="header-title">Current Technologies</h5>
                                    ...
                                    <tbody>
                                        ...
                                        <tr role="row" class="{{ $key % 2 == 0 ? 'odd' : 'even' }}">
                                            ...
                                            <td style="white-space: nowrap; width: 15%;">
                                                ...
                                                <form style="display:inline;" action="{{route('technologies.destroy',$technology->id)}}" method="POST">
                                                    @csrf
                                                    @method('DELETE')
