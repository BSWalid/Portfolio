<x-app-layout>
    ...
    <div class="page-head">
        <h4 class="mt-2 mb-2">Update a Skill</h4>
    </div>
    ...
    <div class="card-body">
        ...
        <div class="general-label">
            <form class="form-horizontal" role="form" enctype="multipart/form-data" method="POST" action="{{route('technologies.update',$technology->id)}}">
                 @csrf
                 @method('PATCH')
