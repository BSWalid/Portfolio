                ...
                <div class="col-lg-12 col-sm-12">
                    ...
                    <div class="card m-b-30">
                        <div class="card-body table-responsive">
                            <h5 class="header-title">Current Projects </h5>
                        ...
                        <div class="row"><div class="col-sm-12">
                            <table id="datatable" class="table table-bordered dataTable no-footer" role="grid" aria-describedby="datatable_info">
                                    ...
                                    <tr role="row">
                                        ...
                                        <th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1" aria-label="Position: activate to sort column ascending" style="width: 385px;">Service</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr role="row" class="{{ $key % 2 == 0 ? 'odd' : 'even' }}">
                                            ...
                                            <td style="white-space: nowrap; width: 15%;">
                                                ...
                                                <a href="{{route('project.edit',$project->id)}}"><button type="button" class="btn btn-primary">
